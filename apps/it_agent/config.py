...
class ITAgentConfig:
    ...
    Attributes:
        ...
        actor_scope: OAuth scope requested when minting the agent actor token.
    ...
    def from_env(
        ...
        actor_scope = env.get(
            "IT_ACTOR_SCOPE",
            "openid internal_login it_assets_read_rest it_assets_self_rest it_assets_write_rest",
        ).strip()
