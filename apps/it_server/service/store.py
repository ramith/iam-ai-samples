...
_SEED_ASSETS: List[Dict] = [
    {"asset_id": "MBP-16-001", "username": "hradmin@example.com",  "type": "laptop",  "model": "MacBook Pro 16",   "status": "outstanding"},
    {"asset_id": "MON-LG-001",  "username": "hradmin@example.com",  "type": "monitor", "model": "LG 27UK850",       "status": "outstanding"},
]

_SEED_USERS: Dict = {
    "employee@example.com": {"username": "employee@example.com", "email": "employee@example.com", "sub": "employee@example.com", "name": "Employee"},
    "hradmin@example.com":  {"username": "hradmin@example.com",  "email": "hradmin@example.com",  "sub": "hradmin@example.com",  "name": "HR Admin"},
}
...
def reset_data() -> None:
    ...
    users = copy.deepcopy(_SEED_USERS)
    if prior_users:
        logger.warning(
